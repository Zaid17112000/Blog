<?php
    ...
    require_once "../functions/validation/check_comment_exists.php";
    require_once "../functions/validation/check_user_like_comment.php";
    require_once "../functions/actions/handle_like_comment.php";
    require_once "../functions/queries/get_like_comment_count.php";
    ...
    $comment_exist = checkCommentExists($pdo, $comment_id);
    if ($comment_exist) {
